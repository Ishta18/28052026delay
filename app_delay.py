...
import pickle
import joblib
loaded_model=joblib.load('logistic.sav')
...
Num_Stops=st.number_input("No of stops", min_value=0)
...
Fuel_Efficiency=st.number_input("in km/lit", min_value=0)
Warehouse_Processing_Time=st.number_input("proc time in min", min_value=0)
